...
function App() {
  return (
    ...
    >
      <ChakraProvider>
        <Center>
          <Heading size="4xl" textAlign="center" color="white" margin="15%">
            aNOTEate
          </Heading>
